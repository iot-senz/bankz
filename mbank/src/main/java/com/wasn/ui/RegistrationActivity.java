...
public class RegistrationActivity extends Activity implements View.OnClickListener {
    ...
    private class SenzCountDownTimer extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            if (!isResponseReceived) {
                String message = "<font color=#000000>Seems we couldn't reach the senz service at this moment. Check whether the Network connection is Available and Try Again </font>";
